...
function App() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      // Create OSM layer with explicit configuration
      ...
      console.log('OSM layer created:', osmLayer);
      ...
      const map = new Map({
        ...
        view: new View({
          center: [0, 0], // World center in Web Mercator
          zoom: 2,
          minZoom: 1,
          maxZoom: 19,
        }),
        controls: [], // Start with no controls to simplify
      });

      console.log('Map created:', map);
      console.log('Map target:', mapRef.current);
      ...
      // Force map to render and handle errors
      setTimeout(() => {
        try {
          map.updateSize();
          map.renderSync();
          console.log('Map forced to render');
        } catch (error) {
          console.error('Error rendering map:', error);
        }
      }, 100);

      // Additional render attempt after longer delay
      setTimeout(() => {
        try {
          map.updateSize();
          console.log('Map size updated again');
          console.log('Final container dimensions:', mapRef.current?.offsetWidth, 'x', mapRef.current?.offsetHeight);
        } catch (error) {
    ...
    <div className="h-screen flex flex-col bg-gray-100">
      ...
      <div className="flex-1 flex">
        ...
        <div className="flex-1 relative">
          {/* Debug info */}
          <div className="absolute top-4 left-4 bg-yellow-100 p-2 rounded text-xs z-50">
